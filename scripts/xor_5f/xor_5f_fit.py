"""Train proset classifier on the 'continuous XOR' problem with 5 features.
...
experiments = (
    ("xor_5f_10b_model", {  # default parameters, 10 batches maximum
        "model_para": {},
        "select_para": {}
    }),
    ("xor_5f_20b_beta_50_model", {  # change beta to 0.5, 20 batches maximum as 10 is selected otherwise
        "model_para": {"beta": 0.5},
