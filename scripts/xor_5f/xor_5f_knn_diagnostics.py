"""Score k-nearest neighbor classifier trained on the 'continuous XOR' problem with 5 features.
...
input_file = "xor_5f_knn_model.gz"
...
x_range, y_range = plotter.plot_surface(
    ...
    baseline=np.ones((1, 5)) * 0.5,  # fix remaining features to positive sign
