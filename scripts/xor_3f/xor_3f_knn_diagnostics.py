"""Score k-nearest neighbor classifier trained on the 'continuous XOR' problem with 3 features.
...
input_file = "xor_3f_knn_model.gz"
...
x_range, y_range = plotter.plot_surface(
    ...
    baseline=np.ones((1, 3)) * 0.5,  # fix remaining features to positive sign
