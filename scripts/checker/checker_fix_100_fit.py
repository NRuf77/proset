...
This test only uses 100 samples per batch.
...
if __name__ == "__main__":
    ...
    output_file = "checker_fix_100_model.gz"
    ...
    result = proset.select_hyperparameters(
        model=proset.ClassifierModel(alpha_v=0.95, alpha_w=0.95, num_candidates=100),
        features=X_train,
        target=y_train,
