...
if __name__ == "__main__":  # need import guard in case of parallel processing
    ...
    experiments = (
        ("checker_2d_05_model", {  # fix both alphas to 5 % and choose optimal penalty weights and number of batches
            "model_para": {"alpha_v": 0.05, "alpha_w": 0.05, "num_candidates": 1000},
            "select_para": {}
        }),
        ("checker_2d_50_model", {  # fix both alphas to 50 % and choose optimal penalty weights and number of batches
            "model_para": {"alpha_v": 0.50, "alpha_w": 0.50, "num_candidates": 1000},
            "select_para": {}
        }),
        ("checker_2d_95_model", {  # fix both alphas to 95 % and choose optimal penalty weights and number of batches
