"""Score proset classifier trained on the continuous XOR' problem with 6 relevant and 6 irrelevant features.
...
input_file = "xor_6_6f_2d_95_model.gz"
...
proset.plot_decision_surface(
    ...
    model_name="XOR 6+6f classifier",
    num_features=12,
