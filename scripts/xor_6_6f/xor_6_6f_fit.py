"""Train proset classifier on the 'continuous XOR' problem with 6 relevant and 6 irrelevant features.
...
data_file = "xor_6_6f_data.gz"
experiments = (
    ("xor_6_6f_10b_model", {  # default parameters, 10 batches maximum, use tensorflow
        "model_para": {"use_tensorflow": True},
        "select_para": {}
    }),
    ("xor_6_6f_10b_beta_50_model", {  # change beta to 0.5
