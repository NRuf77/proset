"""Score k-nearest neighbor classifier trained on the rotated checkerboard pattern.
...
input_file = "checker_rot_knn_model.gz"
...
proset.plot_decision_surface(
    ...
    model_name="checker rot KNN classifier",
