...
Optimize w.r.t. both penalty weights with both alphas at 0.05 (dominant l1 penalty).
...
if __name__ == "__main__":
    ...
    output_file = "iris_2f_2d_05_model.gz"
    ...
    result = proset.select_hyperparameters(
        model=proset.ClassifierModel(alpha_v=0.05, alpha_w=0.05, num_candidates=1000),
        features=X_train,
        target=y_train,
